            ...
            {colors.map((c) => (
              <button
                ...
                className={`
                                    ...
                                    focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--brand-color)]
                                    ${
                                      activeColor === c.id
              ...
              >
                ...
                {activeColor === c.id && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Check className="h-2.5 w-2.5 text-[var(--brand-color)] font-bold bg-white dark:bg-black rounded-full p-0.5 shadow-sm" />
                  </div>
                )}
              </button>
            ))}
